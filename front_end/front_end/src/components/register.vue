<template>
  <div>
    ...
    <div class="inputStyle" id="register">
      <p class="p1"><span style="color: red" v-if="ID.length == 0">*</span>登录学号ID : <el-input type="number" v-model="ID" maxlength="30" show-word-limit></el-input></p>
      <p class="p1"><span style="color: red" v-if="username.length == 0">*</span>姓名 : <el-input type="text" v-model="username" minlength="10" show-word-limit></el-input></p>
      <p class="p1"><span style="color: red" v-if="tel.length == 0">*</span>手机号码 : <el-input type="number" v-model="tel" maxlength="11" minlength="11" show-word-limit></el-input></p>

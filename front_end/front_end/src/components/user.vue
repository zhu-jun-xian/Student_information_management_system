      ...
      <el-container style="height: 700px; border: 1px solid #eee">
        <el-aside width="200px" style="background-color: rgb(238, 241, 246)">
          <el-menu :default-openeds="['1', '2', '3']">
            <el-submenu index="1">
              <template slot="title"
                ><i class="el-icon-message"></i>信息查询</template
              >
              <el-menu-item-group>
                <el-menu-item index="1-0" @click="selectrouteruser"
                  >学生信息</el-menu-item
                >
                <el-menu-item
                  index="1-1"
                  @click.native="statisticsVisible = true"
                  >学生信息统计</el-menu-item
                >
                <!-- <el-menu-item index="1-2" @click.native="dialogVisible = true">学生信息查询</el-menu-item> -->
                <el-menu-item index="1-2" @click="selectuser1"
                  >学生信息查询</el-menu-item
                >
              </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="2">
              <template slot="title"
                ><i class="el-icon-menu"></i>信息修改</template
              >
              <el-menu-item-group>
                <!-- <el-menu-item index="2-1" @click.native="UpdateVisible = true">修改学生信息</el-menu-item> -->
                <el-menu-item index="2-2" @click.native="addVisible = true"
                  >新增学生信息</el-menu-item
                >
            ...
            <el-submenu index="3">
              ...
              >
              <el-menu-item-group>
                <el-menu-item index="3-1" @click.native="passwordVisible = true"
                  >修改密码</el-menu-item
                >
          ...
          <div>
            ...
            >
              ...
              <el-table-column
                ...
                width="180%"
              >
                <el-button size="mini" @click.native="UpdateVisible = true"
                  >Edit</el-button
                >
...
>>>>>>> 0a8afe7b798a86551c38144485137541cde1e0a1
    ...
    >
      <span>
        <el-form ref="passwordform" :model="passwordform" label-width="100px">
          ...
          <el-form-item>
            <el-button type="primary" @click="updatepassonSubmit"
              >确认</el-button
            >
    ...
    <el-dialog title="学生信息录入" :visible.sync="addVisible" width="50%">
      <span>
        ...
        >
          <el-form-item label="学生姓名">
            <el-input
              v-model="addForm.addstudentname"
              style="width: 60%"
            ></el-input>
          </el-form-item>
         <el-form-item label="学号">
            <el-input
              v-model="addForm.addstudentnumber"
              style="width: 60%"
            ></el-input>
          </el-form-item>
           <el-form-item label="班级">

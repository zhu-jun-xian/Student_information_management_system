<template>
  <div class="hello">
    <div>
      ...
      <el-input v-model="search1" placeholder="请输入" style="width:30%;padding-left:300px"  @keydown.enter.native="validateCounts">
      </el-input>
    ...
    <el-container>
      ...
      <div>
        <el-table border class="el-table-column" :data="stuData.slice((currentPage-1)*pageSize,currentPage*pageSize)"
          ...
          <el-table-column align="center" header-align="center" prop="stuBirth" label="出生年月日" width="160%">
          </el-table-column>
          <el-table-column align="center" header-align="center" prop="stuSex" label="性别" width="110%"></el-table-column>
          <el-table-column align="center" header-align="center" prop="stuTel" label="手机号码" width="160%">
          </el-table-column>
          <el-table-column align="center" header-align="center" prop="stuClass" label="班级" width="160%" sortable>
          </el-table-column>
        ...
        <div class="block" style="margin-top:15px;">
          <el-pagination align='center' @size-change="handleSizeChange" @current-change="handleCurrentChange"
            ...
            layout="total, sizes, prev, pager, next, jumper" :total="stuData.length">
          </el-pagination>
        </div>
      </div>
    ...
    <el-dialog title="模糊查询" :visible.sync="selectfuzzyVisible" width="30%">
      <el-form :inline="true" :model="selectfuzzyForm" class="selectfuzzyForm_demo">
        <el-form-item label="学号">
          <el-input v-model="selectfuzzyForm.selectnum"></el-input>
        </el-form-item>
        <el-form-item label="系部：" prop="selectfuzzyacademy">
          <el-select v-model="selectfuzzyForm.selectfuzzyacademy" placeholder="请选择">
            <el-option label="智能制造学部" value="智能制造学部"></el-option>
            <el-option label="土木工程学院" value="土木工程学院"></el-option>
            <el-option label="经济管理学院" value="经济管理学院"></el-option>
            <el-option label="外国语学院" value="外国语学院"></el-option>

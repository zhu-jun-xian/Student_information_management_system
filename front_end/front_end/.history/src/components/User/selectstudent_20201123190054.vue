<template>
  <div class="hello">
    <div>
      <el-row>
        <el-button round  size="small">学生信息查询</el-button>
        <el-button round  size="small" @click.native="selectclassVisible=true">班级查询</el-button>
        <el-button round  size="small" @click.native="selectgendVisible=true">院系查询</el-button> <el-divider></el-divider>
      </el-row> 
    </div>
    <el-container>  

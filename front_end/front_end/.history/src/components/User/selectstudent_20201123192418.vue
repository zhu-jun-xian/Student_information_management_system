<template>
  <div class="hello">
    <div>
        ...
        <el-button round span=2 >学生信息查询</el-button>
        ...
        <el-input  v-model="search" align="left" span=2  placeholder="输入关键字搜索"/>  
      <el-divider></el-divider>
    </div>
    <el-container>  
 
   <div>
    <el-table border class="el-table-column" :data="selectDatas.slice((currentPage-1)*pageSize,currentPage*pageSize)" :default-sort = "{prop: 'date', order: 'descending'}" style="width: 100%" @row-click="rowclick">

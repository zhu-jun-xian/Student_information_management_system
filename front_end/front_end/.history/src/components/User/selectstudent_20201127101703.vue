  ...
  <div class="hello">
    ...
    <el-dialog title="修改学生信息" :visible.sync="UpdateVisible" width="35%">
      <el-form ref="Updateform" :model="Updateform" label-width="100px">
        ...
        <el-form-item label="出生年月" prop="time">              <el-date-picker type="date" v-model="Updateform.time" placeholder="选择日期" style="width: 60%" value-format="yyyyMMdd"></el-date-picker>       </el-form-item>

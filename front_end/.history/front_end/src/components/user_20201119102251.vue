      ...
      <span>
       ...
       <el-form-item label="性别" prop="region">
          <el-select v-model="ruleForm.region" placeholder="请选择">
            <el-option label="女" value="o"></el-option>
            <el-option label="男" value="beijing"></el-option>
          </el-select>
       </el-form-item>
       <el-form-item label="系部" prop="region">
          <el-select v-model="ruleForm.region" placeholder="请选择">
            <el-option label="智能制造学部" value="shanghai"></el-option>
            <el-option label="土木工程学院" value="beijing"></el-option>
            <el-option label="经济管理学院" value="beijing"></el-option>
            <el-option label="外国语学院" value="beijing"></el-option>
            <el-option label="艺术设计学院" value="beijing"></el-option>
          </el-select>
       </el-form-item>
  <el-form-item>

...
<el-dialog title="修改用户信息" :visible.sync="UpdateVisible" width="35%">
    ...
    <el-dialog title="学生信息查询" :visible.sync="dialogVisible" width="35%">
      <span>
        <el-form :model="selectForm" :rules="rules" ref="selectForm" label-width="100px" class="selectForm">
  ...
  <el-form-item>
    ...
    <el-dialog title="学生信息统计" :visible.sync="statisticsVisible" width="35%">
      <span>
        <el-form :model="statisticsForm" :rules="rules" ref="statisticsForm" label-width="100px" class="statisticsForm">
          
       <el-form-item label="信息统计规则" prop="sex">
          <el-select v-model="selectForm.sex" placeholder="请选择">
            <el-option label="院系" value="academy"></el-option>
            <el-option label="性别" value="girl"></el-option>
          </el-select>
       </el-form-item>
       <el-form-item label="学生姓名" prop="stuname">
          <el-input v-model="selectForm.stuname"></el-input>

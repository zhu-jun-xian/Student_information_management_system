     ...
     <el-dialog title="学生信息录入" :visible.sync="addVisible" width="50%">
      <span>
        <el-form :model="addForm" :rules="addrules" ref="addForm" label-width="100px" class="addForm">
          ...
          <el-input v-model="addForm.addstudentname" style="width: 61px;"></el-input>
       </el-form-item>
        <el-form-item label="学号" prop="addstudentnumber">
          <el-input v-model="addForm.addstudentnumber" style="width: 61px;"></el-input>
       </el-form-item>
        <el-form-item label="班级" prop=" addclassnumber">
          <el-input v-model="addForm. addclassnumber" style="width: 61px;"></el-input>
       </el-form-item>
